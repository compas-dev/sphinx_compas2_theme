...
project = "COMPAS 2 Theme for Sphinx"
...
def linkcode_resolve(domain, info):
    ...
    if not package.startswith('sphinx_compas2_theme'):
        return None
    ...
    return f"https://github.com/compas-dev/sphinx_compas2_theme/blob/master/src/{filename}.py#L{lineno}"
...
html_title = "COMPAS 2 Theme for Sphinx"
...
html_theme_options = {
    ...
    "logo": {
        "text": "COMPAS 2 Theme for Sphinx",
...
html_context = {
    ...
    "github_repo": "sphinx_compas2_theme",
    "github_version": "main",
    "doc_path": "docs",
}
